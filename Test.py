...
output_file = open("log/fuzzy_basic.csv", "w")
...
for nb_run in range(3):
    ...
    fuzzy = Fuzzy()
    print("experiment {} #{}:\n\tnode: {}, target: {}, prob: {}, mc: {}, package_size: {}".format(experiment_type, experiment_index, len(net.node), len(net.target), prob, nb_mc, package_size))
